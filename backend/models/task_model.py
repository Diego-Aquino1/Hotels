...
###################################################
    ...
    def get_guest2(self, ID):
        params = {'ID' : ID}
        rv = self.mysql_pool.execute("SELECT * from guests_h2 where ID=%(ID)s", params)                
        data = []
        content = {}
        for result in rv:
            content = {'ID': result[0], 'Apellidos': result[1], 'Nombres': result[2], 'Email': result[3], 'Celular': result[4], 'Habitaciones': result[5], 'Descripcion': result[6]}
    ...
    def get_guests2(self):  
        rv = self.mysql_pool.execute("SELECT * from guests_h2")  
        data = []
        content = {}
        for result in rv:
            content = {'ID': result[0], 'Apellidos': result[1], 'Nombres': result[2], 'Email': result[3], 'Celular': result[4], 'Habitaciones': result[5]}
    ...
    def add_guest2(self, Apellidos, Nombres, Email, Celular, Habitaciones, Descripcion):    
        params = {
            'Apellidos' : Apellidos,
            'Nombres' : Nombres,
            'Email' : Email,
        ...
        query = """INSERT INTO guests_h2 (Apellidos, Nombres, Email, Celular, Habitaciones, Descripcion) 
            values (%(Apellidos)s, %(Nombres)s, %(Email)s, %(Celular)s, %(Habitaciones)s, %(Descripcion)s)"""
    ...
    def delete_guest2(self, ID):    
        params = {'ID' : ID}      
        query = """delete from guests_h2 where ID = %(ID)s"""    
        self.mysql_pool.execute(query, params, commit=True)   
...
###################################################
    ...
    def get_guest3(self, ID):
        params = {'ID' : ID}
        rv = self.mysql_pool.execute("SELECT * from guests_h3 where ID=%(ID)s", params)                
        data = []
        content = {}
        for result in rv:
            content = {'ID': result[0], 'Apellidos': result[1], 'Nombres': result[2], 'Email': result[3], 'Celular': result[4], 'Habitaciones': result[5], 'Descripcion': result[6]}
    ...
    def get_guests3(self):  
        rv = self.mysql_pool.execute("SELECT * from guests_h3")  
        data = []
        content = {}
        for result in rv:
            content = {'ID': result[0], 'Apellidos': result[1], 'Nombres': result[2], 'Email': result[3], 'Celular': result[4], 'Habitaciones': result[5]}
    ...
    def add_guest3(self, Apellidos, Nombres, Email, Celular, Habitaciones, Descripcion):    
        params = {
            'Apellidos' : Apellidos,
            'Nombres' : Nombres,
            'Email' : Email,
        ...
        query = """INSERT INTO guests_h3 (Apellidos, Nombres, Email, Celular, Habitaciones, Descripcion) 
            values (%(Apellidos)s, %(Nombres)s, %(Email)s, %(Celular)s, %(Habitaciones)s, %(Descripcion)s)"""
    ...
    def delete_guest3(self, ID):    
        params = {'ID' : ID}      
        query = """delete from guests_h3 where ID = %(ID)s"""    
        self.mysql_pool.execute(query, params, commit=True)   
...
###################################################
    ...
    def get_guest4(self, ID):
        params = {'ID' : ID}
        rv = self.mysql_pool.execute("SELECT * from guests_h4 where ID=%(ID)s", params)                
        data = []
        content = {}
        for result in rv:
            content = {'ID': result[0], 'Apellidos': result[1], 'Nombres': result[2], 'Email': result[3], 'Celular': result[4], 'Habitaciones': result[5], 'Descripcion': result[6]}
    ...
    def get_guests4(self):  
        rv = self.mysql_pool.execute("SELECT * from guests_h4")  
        data = []
        content = {}
        for result in rv:
            content = {'ID': result[0], 'Apellidos': result[1], 'Nombres': result[2], 'Email': result[3], 'Celular': result[4], 'Habitaciones': result[5]}
    ...
    def add_guest4(self, Apellidos, Nombres, Email, Celular, Habitaciones, Descripcion):    
        params = {
            'Apellidos' : Apellidos,
            'Nombres' : Nombres,
            'Email' : Email,
        ...
        query = """INSERT INTO guests_h4 (Apellidos, Nombres, Email, Celular, Habitaciones, Descripcion) 
            values (%(Apellidos)s, %(Nombres)s, %(Email)s, %(Celular)s, %(Habitaciones)s, %(Descripcion)s)"""
    ...
    def delete_guest4(self, ID):    
        params = {'ID' : ID}      
        query = """delete from guests_h4 where ID = %(ID)s"""    
        self.mysql_pool.execute(query, params, commit=True)   
...
###################################################
    ...
    def get_guest5(self, ID):
        params = {'ID' : ID}
        rv = self.mysql_pool.execute("SELECT * from guests_h5 where ID=%(ID)s", params)                
        data = []
        content = {}
        for result in rv:
            content = {'ID': result[0], 'Apellidos': result[1], 'Nombres': result[2], 'Email': result[3], 'Celular': result[4], 'Habitaciones': result[5], 'Descripcion': result[6]}
    ...
    def get_guests5(self):  
        rv = self.mysql_pool.execute("SELECT * from guests_h5")  
        data = []
        content = {}
        for result in rv:
            content = {'ID': result[0], 'Apellidos': result[1], 'Nombres': result[2], 'Email': result[3], 'Celular': result[4], 'Habitaciones': result[5]}
    ...
    def add_guest5(self, Apellidos, Nombres, Email, Celular, Habitaciones, Descripcion):    
        params = {
            'Apellidos' : Apellidos,
            'Nombres' : Nombres,
            'Email' : Email,
        ...
        query = """INSERT INTO guests_h5 (Apellidos, Nombres, Email, Celular, Habitaciones, Descripcion) 
            values (%(Apellidos)s, %(Nombres)s, %(Email)s, %(Celular)s, %(Habitaciones)s, %(Descripcion)s)"""
    ...
    def delete_guest5(self, ID):    
        params = {'ID' : ID}      
        query = """delete from guests_h5 where ID = %(ID)s"""    
        self.mysql_pool.execute(query, params, commit=True)   
...
###################################################
    ...
    def get_guest6(self, ID):
        params = {'ID' : ID}
        rv = self.mysql_pool.execute("SELECT * from guests_h6 where ID=%(ID)s", params)                
        data = []
        content = {}
        for result in rv:
            content = {'ID': result[0], 'Apellidos': result[1], 'Nombres': result[2], 'Email': result[3], 'Celular': result[4], 'Habitaciones': result[5], 'Descripcion': result[6]}
    ...
    def get_guests6(self):  
        rv = self.mysql_pool.execute("SELECT * from guests_h6")  
        data = []
        content = {}
        for result in rv:
            content = {'ID': result[0], 'Apellidos': result[1], 'Nombres': result[2], 'Email': result[3], 'Celular': result[4], 'Habitaciones': result[5]}
    ...
    def add_guest6(self, Apellidos, Nombres, Email, Celular, Habitaciones, Descripcion):    
        params = {
            'Apellidos' : Apellidos,
            'Nombres' : Nombres,
            'Email' : Email,
        ...
        query = """INSERT INTO guests_h6 (Apellidos, Nombres, Email, Celular, Habitaciones, Descripcion) 
            values (%(Apellidos)s, %(Nombres)s, %(Email)s, %(Celular)s, %(Habitaciones)s, %(Descripcion)s)"""
    ...
    def delete_guest6(self, ID):    
        params = {'ID' : ID}      
        query = """delete from guests_h6 where ID = %(ID)s"""    
        self.mysql_pool.execute(query, params, commit=True)   
